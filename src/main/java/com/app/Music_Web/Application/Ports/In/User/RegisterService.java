...
public interface RegisterService {
    ...
    UserDTO registerGoogleUser(String userName, String email);

    void initiateRegistration(String userName, String email, 
                    String password);
    void completeRegistration(String userDataJson);
}
